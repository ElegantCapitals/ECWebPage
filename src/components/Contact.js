    ...
    <section id="contact" className="section-padding bg-navy-900 dark:bg-gray-900">
      <div className="container-max">
        ...
        <div className="text-center mb-16">
          ...
          <p 
            className={`text-lg text-gray-200 max-w-3xl mx-auto transition-all duration-1000 delay-300 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          >
            <div className="bg-navy-800 dark:bg-gray-800 rounded-lg p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-600 rounded-lg focus:ring-2 focus:ring-gold-500 focus:border-transparent bg-navy-700 text-white placeholder-gray-400 transition-colors duration-200"
          ...
          >
            <div className="space-y-8">
              <div>
                <h3 className="text-2xl font-semibold text-navy-800 dark:text-white mb-6">
                  Contact Information
                </h3>
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <div 
                    key={index}
                    className="flex items-start space-x-4 p-4 bg-navy-800 rounded-lg hover:bg-navy-700 transition-colors duration-200"
                  >
                ...
                <div className="flex space-x-4">
                  {[
                    ...
                    <a
                      key={index}
                      href={social.url}
                      className="w-10 h-10 bg-navy-800 dark:bg-navy-700 text-white rounded-lg flex items-center justify-center hover:bg-gold-500 transition-colors duration-200"
